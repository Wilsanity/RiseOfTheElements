...
public class RootMonster_EarthBarrageState : FSMState
{
    ...
    public RootMonster_EarthBarrageState(RootMonsterEnemyController rootMonsterController, Animator animator)
    {
