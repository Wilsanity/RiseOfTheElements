	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 worldNormalValue50_g18 = worldNormal180;
				...
				float dotResult323 = dot( ( ase_worldViewDir + lambertResult38_g18 ) , worldNormal322 );
...
/*ASEBEGIN
Version=18930
252;616;1523;825;-523.3828;733.2391;1.240898;True;False
...
WireConnection;231;7;333;0
ASEEND*/
//CHKSM=C4EAF4297764F6A76AEB51D7877B95A2DB4D17B8