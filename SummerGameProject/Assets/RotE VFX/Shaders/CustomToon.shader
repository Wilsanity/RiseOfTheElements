...
Shader "CustomToon"
{
	Properties
	{
		...
		_AdditionalRimLightColor("Additional Rim Light Color", Color) = (1,1,1,0)
		[HDR]_AdditionalSpecularColor("Additional Specular Color", Color) = (0,0,0,0)
		[ASEEnd]_AdditionalSpecularIntensity("Additional Specular Intensity", Float) = 1
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 worldPosValue44_g14 = WorldPosition;
				float3 WorldPosition37_g14 = worldPosValue44_g14;
				float3 tanNormal12_g14 = NormalMap115;
				float3 worldNormal12_g14 = float3(dot(tanToWorld0,tanNormal12_g14), dot(tanToWorld1,tanNormal12_g14), dot(tanToWorld2,tanNormal12_g14));
				float3 worldNormalValue50_g14 = worldNormal12_g14;
				float3 WorldNormal37_g14 = worldNormalValue50_g14;
				float3 localAdditionalLightsLambert37_g14 = AdditionalLightsLambert( WorldPosition37_g14 , WorldNormal37_g14 );
				float3 lambertResult38_g14 = localAdditionalLightsLambert37_g14;
				float3 temp_output_235_0 = lambertResult38_g14;
				...
				float4 AdditionalSpecular268 = ( ( smoothstepResult283 * ( float4( FlatResult29_g13 , 0.0 ) * _AdditionalSpecularColor ) ) * _AdditionalSpecularIntensity );
				...
				float4 RimLight169 = ( ( ( pow( ( 1.0 - saturate( ( _RimLightOffset + ViewDirection78 ) ) ) , _RimLightPower ) * ( LightDirection79 * ase_lightAtten ) ) * ( float4( _MainLightColor.rgb , 0.0 ) * _RimLightColor ) ) + ( float4( ( pow( ( 1.0 - saturate( ( 0.6 + ViewDirection78 ) ) ) , 0.1 ) * AdditionalLight260 ) , 0.0 ) * _AdditionalRimLightColor ) );
...
/*ASEBEGIN
Version=18930
0;0;1280;699;1149.748;2176.419;3.424596;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;124;-4057.172,-1355.423;Inherit;False;656.3197;280;;2;114;115;Normal Map;1,1,1,1;0;0
...
Node;AmplifyShaderEditor.RangedFloatNode;309;-640.3902,-367.4321;Inherit;False;Constant;_Float1;Float 1;13;0;Create;True;0;0;0;False;0;False;0.1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;235;-4408.399,-1847.533;Inherit;False;SRP Additional Light;-1;;14;6c86746ad131a0a408ca599df5f40861;7,6,1,9,0,23,0,26,0,27,0,24,0,25,0;6;2;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;15;FLOAT3;0,0,0;False;14;FLOAT3;1,1,1;False;18;FLOAT;0.5;False;32;FLOAT4;0,0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.ColorNode;171;31.11713,-694.2259;Inherit;False;Property;_RimLightColor;Rim Light Color;12;0;Create;True;0;0;0;False;0;False;1,1,1,1;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;313;-1175.001,-493.5025;Inherit;False;Constant;_Float0;Float 0;11;0;Create;True;0;0;0;False;0;False;0.6;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;149;-382.244,-1423.78;Inherit;False;Property;_ShadowOffset;Shadow Offset;9;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;286;-2861.734,-1117.667;Inherit;False;Property;_AdditionalSpecGloss;Additional Spec Gloss;5;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;317;-89.26872,-140.345;Inherit;False;Property;_AdditionalRimLightColor;Additional Rim Light Color;13;0;Create;True;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;163;-1324.177,-1054.429;Inherit;False;Property;_RimLightOffset;Rim Light Offset;10;0;Create;True;0;0;0;False;0;False;0.6;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;168;-789.5666,-928.358;Inherit;False;Property;_RimLightPower;Rim Light Power;11;0;Create;True;0;0;0;False;0;False;0.1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;330;-1699.056,-1296.422;Inherit;False;Property;_AdditionalSpecularIntensity;Additional Specular Intensity;15;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;326;-2125.734,-1149.667;Inherit;False;Property;_AdditionalSpecularColor;Additional Specular Color;14;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=242583EF17F61844FB64C697CE3018CD3709B9F6