...
Shader "FruitSplat"
{
	Properties
	{
		...
		[ASEBegin][HDR]_JuiceColor("Juice Color", Color) = (1.498039,1.498039,1.498039,1)
		_AlphaClip("Alpha Clip", Range( 0 , 10)) = 1
		_Texture0("Texture 0", 2D) = "white" {}
		_NormalOffset("Normal Offset", Range( 0 , 5)) = 0.5
		_NormalStrength("Normal Strength", Range( 0 , 10)) = 3
	...
	SubShader
	{
		...
		Pass
		{
			...
			CBUFFER_END
			sampler2D _Texture0;
			UNITY_INSTANCING_BUFFER_START(FruitSplat)
				UNITY_DEFINE_INSTANCED_PROP(float4, _JuiceColor)
			...
			UNITY_INSTANCING_BUFFER_END(FruitSplat)
						 ...
						 ) : SV_Target
			{
				...
				float4 _JuiceColor_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitSplat,_JuiceColor);
				float4 _Texture0_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitSplat,_Texture0_ST);
				float2 uv_Texture0 = IN.ase_texcoord7.xy * _Texture0_ST_Instance.xy + _Texture0_ST_Instance.zw;
				float4 tex2DNode9 = tex2D( _Texture0, uv_Texture0 );
				
				float2 temp_output_2_0_g2 = uv_Texture0;
				float2 break6_g2 = temp_output_2_0_g2;
				float _NormalOffset_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitSplat,_NormalOffset);
				float temp_output_25_0_g2 = ( pow( _NormalOffset_Instance , 3.0 ) * 0.1 );
				...
				float _NormalStrength_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitSplat,_NormalStrength);
				float temp_output_4_0_g2 = _NormalStrength_Instance;
				...
				float _Specular_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitSplat,_Specular);
				float3 temp_cast_1 = (_Specular_Instance).xxx;
				
				float _Smoothness_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitSplat,_Smoothness);
				
				float2 texCoord21 = IN.ase_texcoord7.zw * float2( 1,1 ) + float2( 0,0 );
				
				float saferPower15 = abs( ( 1.0 - tex2DNode9.r ) );
				float _AlphaClip_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitSplat,_AlphaClip);
				
				float3 Albedo = ( IN.ase_color * ( _JuiceColor_Instance * tex2DNode9 ) ).rgb;
				float3 Normal = normalizeResult22_g2;
				float3 Emission = 0;
				float3 Specular = temp_cast_1;
				float Metallic = 0;
				float Smoothness = _Smoothness_Instance;
				float Occlusion = 1;
				float Alpha = ( 1.0 - texCoord21.x );
				float AlphaClipThreshold = pow( saferPower15 , _AlphaClip_Instance );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float4 _Texture0_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitSplat,_Texture0_ST);
				float2 uv_Texture0 = IN.ase_texcoord2.zw * _Texture0_ST_Instance.xy + _Texture0_ST_Instance.zw;
				float4 tex2DNode9 = tex2D( _Texture0, uv_Texture0 );
				float saferPower15 = abs( ( 1.0 - tex2DNode9.r ) );
				float _AlphaClip_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitSplat,_AlphaClip);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 _JuiceColor_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitSplat,_JuiceColor);
				float4 _Texture0_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitSplat,_Texture0_ST);
				float2 uv_Texture0 = IN.ase_texcoord2.xy * _Texture0_ST_Instance.xy + _Texture0_ST_Instance.zw;
				float4 tex2DNode9 = tex2D( _Texture0, uv_Texture0 );
				
				float2 texCoord21 = IN.ase_texcoord2.zw * float2( 1,1 ) + float2( 0,0 );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float4 _Texture0_ST_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitSplat,_Texture0_ST);
				float2 uv_Texture0 = IN.ase_texcoord3.zw * _Texture0_ST_Instance.xy + _Texture0_ST_Instance.zw;
				float4 tex2DNode9 = tex2D( _Texture0, uv_Texture0 );
				float saferPower15 = abs( ( 1.0 - tex2DNode9.r ) );
				float _AlphaClip_Instance = UNITY_ACCESS_INSTANCED_PROP(FruitSplat,_AlphaClip);
...
/*ASEBEGIN
Version=18921
-163.3333;531.3334;1428;1009;1782.607;277.3095;1.673418;True;False
Node;AmplifyShaderEditor.TexturePropertyNode;27;-1699.632,-177.4071;Inherit;True;Property;_Texture0;Texture 0;4;0;Create;True;0;0;0;False;0;False;741bfd57196e76443917606cfd93cf89;741bfd57196e76443917606cfd93cf89;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.ColorNode;8;-1203.963,-248.6747;Inherit;False;InstancedProperty;_JuiceColor;Juice Color;0;1;[HDR];Create;True;0;0;0;False;0;False;1.498039,1.498039,1.498039,1;2,2,2,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TextureCoordinatesNode;21;-898.7342,567.6815;Inherit;True;1;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;9;-1343.083,-34.44498;Inherit;True;Property;_MainTexture;Main Texture;3;0;Create;True;0;0;0;False;0;False;-1;741bfd57196e76443917606cfd93cf89;741bfd57196e76443917606cfd93cf89;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;28;-618.18,-379.5347;Inherit;False;InstancedProperty;_NormalOffset;Normal Offset;5;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;5;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;14;-941.8986,198.1035;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.BreakToComponentsNode;20;-626.4807,569.5539;Inherit;True;FLOAT2;1;0;FLOAT2;0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.RangedFloatNode;29;-621.0829,-266.8352;Inherit;False;InstancedProperty;_NormalStrength;Normal Strength;6;0;Create;True;0;0;0;False;0;False;3;3;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.VertexColorNode;12;-907.5543,-316.2109;Inherit;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;10;-926.1118,-64.60389;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;16;-969.8179,423.9191;Inherit;False;InstancedProperty;_AlphaClip;Alpha Clip;3;0;Create;True;0;0;0;False;0;False;1;0;0;10;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;15;-605.7065,229.4947;Inherit;True;True;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;30;-326.9709,26.3814;Inherit;False;InstancedProperty;_Smoothness;Smoothness;8;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;31;-332.1909,132.038;Inherit;False;InstancedProperty;_Specular;Specular;7;0;Create;True;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;22;-273.7729,479.391;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;26;-324.7423,-341.4552;Inherit;True;NormalCreate;1;;2;e12f7ae19d416b942820e3932b56220f;0;4;1;SAMPLER2D;;False;2;FLOAT2;0,0;False;3;FLOAT;0.5;False;4;FLOAT;3;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;13;-646.5656,-103.3458;Inherit;True;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;0,0;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;FruitSplat;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;18;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;False;0;Hidden/InternalErrorShader;0;0;Standard;38;Workflow;0;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Write Depth;0;  Early Z;0;Vertex Position,InvertActionOnDeselection;1;0;8;False;True;True;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=014869D755EC940BA13E1BA36FF046D47F58F86D