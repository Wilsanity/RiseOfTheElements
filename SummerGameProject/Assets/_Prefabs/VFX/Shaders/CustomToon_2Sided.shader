	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 worldNormalValue50_g8 = worldNormal180;
				float3 WorldNormal13_g8 = worldNormalValue50_g8;
				float3 temp_output_15_0_g8 = temp_output_179_0;
				...
				float3 temp_output_14_0_g8 = ( lerpResult215 * float4( lambertResult38_g7 , 0.0 ) ).rgb;
				...
				float3 smoothstepResult283 = smoothstep( temp_cast_2 , temp_cast_3 , pow( specularResult61_g8 , temp_cast_6 ));
...
/*ASEBEGIN
Version=18930
200.6667;72.66667;775.3333;335;3829.34;1793.778;4.679481;True;False
...
ASEEND*/
//CHKSM=EA5D260C89851964BCB4F326F882C59C53411AA7