...
{
    private RootSpearsState _rootSpearState;
    ...
    public void Initialize(RootSpearsState rootSpearState, RootMonsterEnemyController enemyController, float groundHeight)
    {
        _spikeUp = 0;
